...
class Security{
     ...
     */
	function Security($hex = false, $debug = false)
	{
		$this->debug = $debug;
		$this->toHex = $hex;	  
	}
	...
	public function baseEncrypt($data,$privateKey_1,$privateKey_2){
		$key_1 = $this->makeKey($privateKey_1);
		$key_2 = $this->makeKey($privateKey_2);
		$encode = $data;// 被加密的字符串
		$ct = $this->encryptString($encode, $key_1);
		$ct = $this->encryptString($ct, $key_2);
		return $ct;
	}

	public function baseDecrypt($data,$privateKey_1,$privateKey_2){
		$key_1 = $this->makeKey($privateKey_1);
		$key_2 = $this->makeKey($privateKey_2);
		$encode = $data;// 被加密的字符串
		$ct = $this->decryptString($encode, $key_2);
		$ct = $this->decryptString($ct, $key_1);
		return $ct;
	}
	...
	public function encrypt($data){
		global $KEY_1_PATH;
		global $KEY_2_PATH;
		$key_1 = file_get_contents($KEY_1_PATH);
		$key_2 = file_get_contents($KEY_2_PATH);
		return $this->baseEncrypt($data,$key_1,$key_2);
	}
	...
	public function decrypt($data){
		...
		$key_1 = file_get_contents($KEY_1_PATH);
		$key_2 = file_get_contents($KEY_2_PATH);
		return $this->baseDecrypt($data,$key_1,$key_2);
	}
}
?>